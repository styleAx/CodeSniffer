 ...
 * @link      http://pear.php.net/package/PHP_CodeSniffer
 */
class Nexus_Sniffs_Commenting_FunctionCommentSniff implements PHP_CodeSniffer_Sniff
{
                    ...
                    if ($typeName !== $suggestedName) {
                        ...
                        if ($suggestedTypeHint !== '' && isset($realParams[($pos - 1)]) === true) {
                            ...
                            if ($typeHint === '') {
                                ...
                                $this->currentFile->addWarning($error, ($commentEnd + 2), 'TypeHintMissing', $data);
    ...
    {
        #  <error line="120" column="1" severity="warning" message="@author tag is not allowed in function comment" source="Nexus.Commenting.FunctionComment.TagNotAllowed"/>
